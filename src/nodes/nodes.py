...
cloud_import = sly.solution.CloudImportNode(x=480, y=30, api=g.api, project_id=g.project.id)
auto_import = sly.solution.AutoImportNode(x=820, y=30, api=g.api, project_id=g.project.id)
